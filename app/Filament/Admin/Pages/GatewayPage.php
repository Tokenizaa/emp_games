...
class GatewayPage extends Page
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('SilverPay')
                    ->description(new HtmlString('<div style="display: flex; align-items: center;">Precisa de uma conta Divpag? Registre-se agora mesmo:
                            <a class="dark:text-white" style="font-size: 14px;font-weight: 600;width: 127px;display: flex;background-color: #00b54d;padding: 10px;border-radius: 11px;justify-content: center;margin-left: 10px;" href="https://divpag.com" target="_blank">Dashboard</a>
                            <a class="dark:text-white" style="font-size: 14px;font-weight: 600;width: 127px;display: flex;background-color: #00b54d;padding: 10px;border-radius: 11px;justify-content: center;margin-left: 10px;" href="https://wa.me/+557776038375" target="_blank">Gerente</a>
                        </div>'))
                    ->schema([
